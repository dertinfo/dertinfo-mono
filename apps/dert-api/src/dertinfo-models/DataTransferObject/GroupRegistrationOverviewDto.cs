...
{
    /// <summary>
    /// This is the object returned to the interface to fulfil the overview view on a registration viewed from the group perspective
    /// </summary>
    public class GroupRegistrationOverviewDto
    {
