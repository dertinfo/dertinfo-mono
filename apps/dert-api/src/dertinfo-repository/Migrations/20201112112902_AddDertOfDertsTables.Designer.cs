...
namespace DertInfo.Repository.Migrations
{
    ...
    [Migration("20201112112902_AddDertOfDertsTables")]
    partial class AddDertOfDertsTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DertInfo.Models.Database.DodResult", b =>
                {
                    ...
                    b.Property<int?>("DodSubmissionId");

                    b.Property<string>("DodUserId");

                    b.Property<int?>("DodUserId1");
                    ...
                    b.HasIndex("DodSubmissionId");

                    b.HasIndex("DodUserId1");
            ...
            modelBuilder.Entity("DertInfo.Models.Database.DodUser", b =>
                {
                    ...
                    b.Property<DateTime>("DateGdpaGained");

                    b.Property<DateTime>("DateModified");

                    b.Property<string>("Email");

                    b.Property<bool>("GdpaGained");
            ...
            modelBuilder.Entity("DertInfo.Models.Database.DodResult", b =>
                {
                    b.HasOne("DertInfo.Models.Database.DodSubmission")
                        .WithMany("DodResults")
                        .HasForeignKey("DodSubmissionId");

                    b.HasOne("DertInfo.Models.Database.DodUser")
                        .WithMany("DodResults")
                        .HasForeignKey("DodUserId1");
                });
