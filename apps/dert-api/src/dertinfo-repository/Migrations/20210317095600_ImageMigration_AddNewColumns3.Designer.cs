...
namespace DertInfo.Repository.Migrations
{
    ...
    [Migration("20210317095600_ImageMigration_AddNewColumns3")]
    partial class ImageMigration_AddNewColumns3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DertInfo.Models.Database.DodTalk", b =>
                {
                    ...
                    b.Property<string>("BroadcastWebLink")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DertInfo.Models.Database.DodUser", b =>
                {
                    ...
                    b.Property<bool>("InterestedInJudging")
                        .HasColumnType("bit");
                    ...
                    b.Property<DateTime>("RecoveryPermittedUntil")
                        .HasColumnType("datetime2");

                    b.Property<bool>("ResultsBlocked")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("DertInfo.Models.Database.NotificationAudienceLog", b =>
                {
                    ...
                    b.Property<DateTime?>("DateAcknowledgedOn")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("DateClearedOn")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("DateCreated")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("DateDismissedOn")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("DateModified")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("DateNotifiedOn")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("DateOpenedOn")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("DateSeenOn")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("UserAuth0Identifier")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DertInfo.Models.Database.NotificationLastCheck", b =>
                {
                    ...
                    b.Property<DateTime>("LastCheckPerformedAt")
                        .HasColumnType("datetime2");

                    b.Property<int>("MaximumMessageSeverity")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DertInfo.Models.Database.NotificationMessage", b =>
                {
                    ...
                    b.Property<bool>("RequiresOpening")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("DertInfo.Models.Database.NotificationAudienceLog", b =>
                {
                    b.HasOne("DertInfo.Models.Database.NotificationMessage", "NotificationMessage")
                        .WithMany("NotificationAudience")
            ...
            modelBuilder.Entity("DertInfo.Models.Database.NotificationMessage", b =>
                {
                    b.Navigation("NotificationAudience");
                });
