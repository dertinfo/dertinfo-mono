...
.EXAMPLE
  .\Remove-DertInfoSubscriptionOidcIdentity.ps1 -ClientId '11111111-2222-3333-4444-555555555555'

.EXAMPLE
  .\Remove-DertInfoSubscriptionOidcIdentity.ps1 -ClientId '11111111-2222-3333-4444-555555555555' -Force
#>
