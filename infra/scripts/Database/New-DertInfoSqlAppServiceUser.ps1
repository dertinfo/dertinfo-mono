...
.DESCRIPTION
  ...
  As an operator I run this script to bind the API App Service identity in Azure SQL because I want the hosted API to log in.
...
.EXAMPLE
  .\Database\New-DertInfoSqlAppServiceUser.ps1 -GitHubEnvironment production -UserName 'someone@contoso.com'
#>
[CmdletBinding()]
param(
